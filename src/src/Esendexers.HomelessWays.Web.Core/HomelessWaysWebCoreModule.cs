...
namespace Esendexers.HomelessWays
{
    ...
    public class HomelessWaysWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public HomelessWaysWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HomelessWaysWebCoreModule).GetAssembly());
        }
    }
}
